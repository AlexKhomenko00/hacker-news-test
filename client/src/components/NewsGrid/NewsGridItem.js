...
import { formatTime, parseParagraph } from "../helpers/render.js";

const NewsGridItem = ({ news: { title, text, by, time, id, score } }) => {
  return (
    <li
      key={id}
    ...
    >
      <Link to={`/news/${id}`} className="flex flex-grow">
        <article className="news-content flex justify-between flex-grow flex-col flex-wrap">
